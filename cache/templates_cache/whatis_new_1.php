...
<div class="row_sidebar pkr pkr-b">
<ul class="whatis_new">
...
<li class="Photo_lastPoster pkr-b" style="display:inline-block; margin-top:-3px; padding:2px; border: 1px solid rgb(165,227,228); width: 32px; height: 32px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px; border-radius: 4px;">
...
<div><i class="IconNewsTime fa fa-history pkr-c"></i>
<?php echo $PowerBB->functions->time($PowerBB->_CONF['template']['while']['lastPostsList'][$this->x_loop]['write_time']); ?>
<span class="last_time_ago"><?php echo $PowerBB->functions->time_ago($PowerBB->_CONF['template']['while']['lastPostsList'][$this->x_loop]['write_time']); ?></span>
</div>
</li>
</ul>
</li>
