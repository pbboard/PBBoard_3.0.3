...
var AjaxState = {ajaxSend : status_r_.html("<img alt='' class='brd0' src='{$image_path}/loading.gif'>")};
...
{if {$NO_SUBJECTS}}
<tr>
<td class="thead pkr pkr-b wd75 a-center" colspan="2">
...
<td class="thead pkr pkr-b forum_sub_rep wd4 nwrp a-center">
...
<td class="thead pkr pkr-b forum_sub_vis wd4 nwrp a-center">
...
<td class="thead pkr pkr-b forum_sub_lasts wd25 nwrp a-center">
...
{if !{$mod_toolbar}}
<td class="thead pkr pkr-b wd1 nwrp">
...
<tr>
<td colspan="{$colspan}" class="thead pkr pkr-b wd98 a-center">
...
<td class="thead pkr pkr-b wd30">{$lang['online_naw']} : {$online_number}
...
<td class="thead pkr pkr-b wd20">{$lang['moderators_forum']}</td>
</tr>
<tr>
...
title="{$lang['rss_section']}" /></a></span>{/if}</td>
</tr>
</table>
</div>
</td>
