...
<div class="Ajax-static pkr-b" id="active_statistics_list">
...
<td class="thead1 pkr pkr-b right_text_align">
{$lang['user_name']}</td>
<td class="thead1 pkr pkr-b right_text_align">
&nbsp;{$lang['posts']}</td>
</tr>
...
<tr style="vertical-align: top;">
<td class="row2 right_text_align wd100">
<span class="smallfont">
...
<td class="row2 left_text_align wd1" title="{$lang['date_register']}">
&nbsp;<span class="smallfont">{$latest_registered['register_date']}</span></td>
</tr>
{/Des::while}
</table>
</div>		<div id='invite_table'>
<table class="wd100 brd0 clp0" style="border-collapse: collapse">
...
<ul class="rUlRow">
<li class="pp-tab pkr">
<div class='pp-taboff3 pkr' id='pp-lastsubject'>{$lang['LastSubject']}</div>
<div class='pp-taboff3 pkr' id='pp-topsubjects'>{$lang['TopSubjectVisitor']}</div>
<div class='pp-taboff3 pkr' id='pp-topsections'>{$lang['most_popular_forums']}</div>
</li>
</ul>
...
<i class="fa fa-sticky-note pkr-c"></i>&nbsp;
...
document.getElementById('pp-lastsubject').className="pp-tabon3 pkr";
document.getElementById('pp-topsubjects').className="pp-taboff3 pkr";
document.getElementById('pp-topsections').className="pp-taboff3 pkr";
updatecolor();
}
else
{
...
$("#topsections_table").hide();
document.getElementById('pp-lastsubject').className="pp-taboff3 pkr";
document.getElementById('pp-topsubjects').className="pp-tabon3 pkr";
document.getElementById('pp-topsections').className="pp-taboff3 pkr";
updatecolor();
}
else
...
document.getElementById('pp-lastsubject').className="pp-taboff3 pkr";
document.getElementById('pp-topsubjects').className="pp-taboff3 pkr";
document.getElementById('pp-topsections').className="pp-tabon3 pkr";
updatecolor();
}
else
{
