...
$l['done_whats_next'] = '<div class="error"><p><strong>Switching from another forum software?</strong></p><p>PBBoard offers a merge system for easy merging of multiple forums from various different popular forum software, allowing an easy conversion process to PBBoard. If you\'re looking to switch to PBBoard, you\'re heading in the right direction! Check out the <a target="_blank" href="http://www.pbboard.info/categorie_12">Merge System</a> for more information.</p>';
