...
define('CLASS_NAME','PowerBBFixrMOD');
class PowerBBFixrMOD
{
	function run()
	{
		global $PowerBB;

		if(file_exists("install/upgrade.php"))
         {
	...
	function _AllCacheStart()
	{
		...
		while ($x < $y)
		{
	       ...
	       $PowerBB->functions->redirect('install/upgrade.php?step=upgrade303_update_section_cache');
